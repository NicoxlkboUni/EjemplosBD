...
WHERE NOT EXISTS (SELECT *
				 FROM VENTA V
				 WHERE V.NCLIENTE = C.NCLIENTE AND V.FECHA BETWEEN '01-10-2023' AND '31-10-2023');
...
SELECT P.NOMBRE, SUM(P.PRECIO+V.CANTIDAD) AS VALOR_TOTAL
FROM PRODUCTO P, VENTA V
WHERE P.COD=V.COD AND V.FECHA LIKE '15-10-2023'
GROUP BY P.NOMBRE;
...
SELECT P.COD, C.NOMBRE, V.FECHA, P.PRECIO*V.CANTIDAD AS VENTA_TOTAL
